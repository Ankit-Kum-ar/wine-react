...
const Banner = () => {
  return (
    <div className="bg-[#6B2F1F] flex flex-col justify-center items-center gap-8 p-10   w-full ">
      ...
      <p className="text-white text-lg md:text-2xl w-[50vw] text-center font-manrope">From the golden fields of barley to the ancient barrels that breathe life into our whiskey, every drop tells a story of passion, tradition, and artistry</p>
