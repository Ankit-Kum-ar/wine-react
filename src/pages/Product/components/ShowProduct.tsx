...
const ShowProduct = () => {
  return (
    ...
    <div className="flex md:flex-row flex-col justify-center items-center w-full md:gap-0 gap-20 ">
        <div className="flex-col justify-center items-start md:gap-9 gap-4 flex md:w-1/2">
