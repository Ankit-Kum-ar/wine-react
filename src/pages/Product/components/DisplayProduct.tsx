...
const DisplayProduct: React.FC<DisplayProductProps> = ({ imgSrc_1, imgSrc_2, title_1, title_2, desc_a_1, desc_a_2, desc_b_1, desc_b_2 }) => {
  return (
    <div className="flex flex-col justify-center items-center bg-[#FCF5EA] md:p-14 py-9 px-5 w-full md:gap-0 gap-12">
      <div className="flex md:flex-row flex-col justify-center items-center md:gap-9 gap-4">
        ...
        <div className="flex flex-col justify-start items-start md:gap-9 gap-3 md:w-1/2">
            ...
            <p className="md:text-lg text-sm font-glass-anitqua">{desc_a_1}</p>
            <p className="md:text-lg text-sm font-glass-anitqua">{desc_a_2}</p>
        </div>
      </div>
      ...
      <div className="flex md:hidden flex-col justify-center items-center gap-4">
        ...
        <div className="flex flex-col justify-start items-start md:gap-9 gap-3 md:w-1/2">
            ...
            <p className="md:text-lg text-sm font-glass-anitqua">{desc_b_1}</p>
            <p className="md:text-lg text-sm font-glass-anitqua">{desc_b_2}</p>
        </div>
      </div>
    </div>
  )
