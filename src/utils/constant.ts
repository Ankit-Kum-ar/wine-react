...
export const carouselImagesContentArray_01 = [
    ...
    {
        title: `Patron`,
        description: `Patrón Tequila is a brand of tequila products produced in Mexico by the Patrón Spirits Company. Patrón tequila is offered in several different varieties: Gran Patrón Burdeos, Gran Patrón Platinum, Gran Patrón Piedra, Patrón Silver, Patrón Añejo, and Patrón Reposado. It is the best-selling tequila in the world. Patron Tequila is a favorite of many celebrities and is often seen in movies and TV shows.`
    },
]
