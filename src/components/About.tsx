...
const About = () => {
  return (
    ...
    <div >
        ...
        <p className="mt-4 text-sm md:text-lg text-[#1B1C1E] text-justify font-abel">we aspire to become an entity that consistently improves product, reach and ability and, in doing so, creates a unique identity for ourselves in the wines & spirits industry.</p>
