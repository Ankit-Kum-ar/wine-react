    ...
    <div>
      <div  className='HeroContent bg-[url(images/webp.png)] bg-cover bg-no-repeat  flex flex-col justify-center h-[100vh] w-full items-center'>
        <div className='flex flex-col items-center justify-center w-12/12 md:w-8/12 z-10 mt-10 px-6 md:px-0'>
            <h2 className='greeting text-white text-2xl md:text-5xl  text-center  z-10 font-anybody font-sail '>Exclusive</h2>
            <h2 className='greeting text-white text-lg md:text-5xl text-center z-10 font-sail'>Collection of <br />Rare Liquor <br /> Awaits</h2>
