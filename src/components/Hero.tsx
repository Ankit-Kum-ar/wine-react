...
const Hero = () => {
  return (
    <div>
      ...
      <Button  className='greeting text-white bg-[#164328] border-2 border-solid border-[#4D6A52] text-center px-4 py-1 z-20 font-anybody rounded-none hover:bg-[#4D6A52] cursor-pointer'>Shop now</Button>
    </div>
    </div>
  )
}
